                        ...
                        @if ($presensipulang == null)
                            <form action="{{ route('checklog.store') }}" method="post" class="mb-3"
                                ...
                                <div class="form-group mb-3 text-center">
                                    ...
                                    <video id="video"
                                        style="width: { min: 160, ideal: 270: max: 720 },height: { min: 240, ideal: 480, max: 720 } "
                                        autoplay></video><br>
                                    {{-- <button type="button" id="click-photo" class="btn btn-secondary">Ambil Foto</button><br> --}}
                                    <canvas id="canvas"
                                        style="display: none;width: { min: 160, ideal: 270: max: 720 },height: { min: 240, ideal: 480, max: 720 } "></canvas>
